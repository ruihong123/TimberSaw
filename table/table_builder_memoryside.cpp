...
struct TableBuilder_Memoryside::Rep {
  ...
  pending_index_filter_entry(false) {
    ...
    rdma_mg->Allocate_Local_RDMA_Slot(*local_index_mr, "DataIndexBlock");
    rdma_mg->Allocate_Local_RDMA_Slot(*local_filter_mr, "FilterBlock");
...
TableBuilder_Memoryside::~TableBuilder_Memoryside() {
  ...
  rep_->rdma_mg->Deallocate_Local_RDMA_Slot(rep_->local_index_mr->addr, "DataIndexBlock");
  rep_->rdma_mg->Deallocate_Local_RDMA_Slot(rep_->local_filter_mr->addr, "FilterBlock");
...
//  std::shared_ptr<RDMA_Manager> rdma_mg =  r->options.env->rdma_mg;
  ...
  r->rdma_mg->Allocate_Local_RDMA_Slot(*r->local_index_mr, "DataIndexBlock");
...
//  std::shared_ptr<RDMA_Manager> rdma_mg =  r->options.env->rdma_mg;
  ...
  r->rdma_mg->Allocate_Local_RDMA_Slot(*r->local_filter_mr, "FilterBlock");
