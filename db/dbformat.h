...
static const int Immutable_StopWritesTrigger = 32; // should be 15, add memtable should be totally 16 (new 16 shards:2
...
static const int kL0_SlowdownWritesTrigger = 16; // (new 16 shards is 1
...
static const int kL0_StopWritesTrigger = 32; // (new 16 shards is 2.
