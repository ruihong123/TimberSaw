...
namespace config { //default 16, 20, 36
...
static const int Immutable_StopWritesTrigger = 7; // Default 0 shard should be 15, add memtable should be totally 16 (new 16 shards:2
...
static const int kL0_SlowdownWritesTrigger = 8; // (new 16 shards is 1, Default (0 shard) is 16
...
static const int kL0_StopWritesTrigger = 16; // (new 16 shards is 2. Default(0 shard) is 32.
...
static const double max_mega_bytes_for_level_base = 512.0;
