...
static const int kL0_SlowdownWritesTrigger = 16; // (new 16 shards is 1, Default (0 shard) is 16
...
static const int kL0_StopWritesTrigger = 32; // (new 16 shards is 2. Default(0 shard) is 32.
