...
static const int kL0_SlowdownWritesTrigger = 1; // (new 16 shards is 1, Default (0 shard) is 16
...
static const int kL0_StopWritesTrigger = 2; // (new 16 shards is 2. Default(0 shard) is 32.
