...
static const int Immutable_StopWritesTrigger = 1; // Default 0 shard should be 15, add memtable should be totally 16 (new 16 shards:2
...
static const int kL0_SlowdownWritesTrigger = 2; // (new 16 shards is 1, Default (0 shard) is 16
...
static const int kL0_StopWritesTrigger = 4; // (new 16 shards is 2. Default(0 shard) is 32.
