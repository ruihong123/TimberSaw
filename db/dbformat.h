...
static const int Immutable_StopWritesTrigger = 16; // should be 15, add memtable should be totally 16 (new 16 shards:2
...
static const double max_mega_bytes_for_level_base = 64.0;
