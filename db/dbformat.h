...
static const int Immutable_StopWritesTrigger = 31; // Default 0 shard should be 15, add memtable should be totally 16 (new 16 shards:2
...
static const int kL0_SlowdownWritesTrigger = 32; // (new 16 shards is 1, Default (0 shard) is 16
...
static const int kL0_StopWritesTrigger = 64; // (new 16 shards is 2. Default(0 shard) is 32.
