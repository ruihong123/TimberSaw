...
#define TABLE_STRATEGY 2 // 0 PURE block based, 1 pure byte-addressable, 2 adaptive according to local cache size limit.
...
#define R_SIZE 1024
#define TABLE_TYPE_ADJUST_THRESHOLD (128.00*1024.00*1024.00)
